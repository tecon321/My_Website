...
//
//     playTurn(h,d){
//         //play turn depending on user/dealer strategy
//         this._strategy.playTurn(this.hand, this.deck);
//         //return;
//     }
//
//     // isDone(){
...
//     playTurn(h,d){
        ...
        //     //execute hit command
        //     manager.execute(new StayCommand(h,d));
        //     //this.endTurn();
        //     //return true;
        // });
        //
...
// function playerTurn(h,d){ //make playerTurn class with strategy? end turn method?
//     //open command interface
//     const manager = new CommandManager();
//     //display command interface
//     var myDiv = document.getElementById("buttons");
...
//STATE MACHINE-----------------------------------------------------------------------------------
var Round = function(game,hands,deck){
    ...
    this.changeState = function(state){
        ...
        //alert("change state");
        currState = state;
        currState.playTurn(hands[1],deck);
    };

    //start a round of blackjack
    this.startRound = function(){
        currState.playTurn(hands[0],deck);
    };
    ...
    this.endRound = function(){
        ...
        for(var i = 0; i<hands.length;i++){
            if(hands[i].getType()==0){
                hands[i].showHand(true);
            }
        }
        ...
        // Determine Winner ----------------------
        // var dealerTotal = hands[1].getHandValue();
        // var playerTotal = hands[0].getHandValue();
        //
        // //player wins
...
// var checkBlackjack = function(round){
//     this.round = round;
//     this.playTurn = function(h,d){
//         var handTotal = h.getHandValue();
//         if(handTotal == 21){
//             alert("Blackjack!");
...
var PlayerTurn = function(round){
    ...
    this.playTurn = function(h,d){
        ...
        if(ht==21){
            ...
            document.getElementById("doublebutton").addEventListener("click", function(){
                //execute hit command
                manager.execute(new DoubleCommand(h,d));
                round.changeState(new DealerTurn(round));
                //return true;
            });
            //return;
...
class TestGame
{
    ...
    play(){
        ...
        //once round is over, determine winner
        ...
        //
        // //loop through players, call setStrategy(players[i].getType())
        // strategyManager.setStrategy(this.phand,playerStrategy);
        // //var done = false;
        // // while (done == false){
        // //     done = strategyManager.playTurn();
        // // }
        // strategyManager.playTurn();
        //
        // // setTimeout( func2, 3000); //set 30 second timer for choosing a move
        // //
        // // function func2(){
        // //     // Code that will run
        // // 	// after 3 seconds.
        // strategyManager.setStrategy(this.dhand, dealerStrategy);
        // strategyManager.playTurn();
        // // }
