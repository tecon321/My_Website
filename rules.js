...
function begin_play(){
    ...
    if(isEmpty(p1) || isEmpty(p2))
    {
        ...
        //alert("run");
        // var v = document.getElementById('player1').style;
        // v.visibility = "hidden";
        ...
        document.getElementById('turn_info').innerHTML = "Turn for: " + pturn.bold();
        started = true;
    }
}
...
function play() {
    ...
    for(var i = 0; i < table_ids.length; i++)
    {
        ...
        {
            if(document.getElementById(input).innerHTML == input){
                valid = true;
                loc = i;
            }
            //document.write(document.getElementById(input).innerHTML);
            //valid = true;
            //alert("valid");
        }
    }
    if(valid == false)
    {
        ...
        else if(board_state[0] == board_state[3] && board_state[0] == board_state[6] && board_state[0] != -1)
        {
            hasWinner = true;
            if(board_state[0] == 1)
            {
